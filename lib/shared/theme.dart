...
Color whiteColor = const Color(0xffFFFFFFF);
Color blackColor = const Color(0xff0D3F27);
...
Color redColor = const Color(0xffE83845);
Color yellowColor = const Color(0xffF29339);
